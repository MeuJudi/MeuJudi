    ...
    <div className="space-y-6">
      <section className="rounded-lg border border-[var(--tenant-line)] bg-[var(--tenant-surface)] p-5 text-[var(--tenant-surface-foreground)]">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div><h2 className="font-display text-xl font-semibold text-[var(--color-card-foreground)]">Parear o MeuJudi Sync</h2><p className="mt-1 max-w-2xl text-sm text-[var(--color-muted-foreground)]">Gere um codigo para conectar o aplicativo instalado no computador do escritorio. O codigo expira em 10 minutos.</p></div>
      ...
      <section className="rounded-lg border border-[var(--tenant-line)] bg-[var(--tenant-surface)] p-5 text-[var(--tenant-surface-foreground)]">
        ...
        <p className="mt-1 text-sm text-[var(--color-muted-foreground)]">O status e atualizado automaticamente enquanto o MeuJudi Sync estiver aberto.</p>
