...
export default async function TarefasPage() {
  ...
  if (!tenantId) return <TarefasView tenantId={null} columns={[]} tasks={[]} users={[]} currentUser={{ id: profile.id, name: profile.name, nickname: profile.nickname, email: profile.email, oab_number: profile.oab_number, oab_uf: profile.oab_uf, avatar_url: null, gender: profile.gender }} />;
