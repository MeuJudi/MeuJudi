...
/**
 * Validacao de OAB em andamento (Fase 3 do ConfirmADV). Espelha o que o
 * Web retorna em GET /api/cs/oab-validations.
 */
export interface ConfirmADVValidation {
  id: string;
  oab_number: string;
  oab_uf: string;
